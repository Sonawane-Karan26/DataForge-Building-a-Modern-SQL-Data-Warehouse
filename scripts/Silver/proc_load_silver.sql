		...
		PRINT '=========================================='
			...
			SELECT 
				...
				CASE WHEN bdate > GETDATE() THEN NULL
					 ELSE bdate
				END AS bdate,
				CASE WHEN UPPER(TRIM(country)) IN ('F', 'Female') THEN 'Female'
					 WHEN UPPER(TRIM(country)) IN ('M', 'Male') THEN 'Male'
					 ELSE 'n/a'
				END AS gender
			...
			BEGIN CATCH
				PRINT ' ==================================================== '
				PRINT 'ERROR occured during loading Bronze Layer to Silver'
